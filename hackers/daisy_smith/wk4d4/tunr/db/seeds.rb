...
u1 = User.create(:username => 'peter', :password => 'chicken', :password_confirmation => 'chicken')
u2 = User.create(:username => 'cry', :password => 'chicken', :password_confirmation => 'chicken')
u3 = User.create(:username => 'craigsy', :password => 'chicken', :password_confirmation => 'chicken', :is_admin => true)
