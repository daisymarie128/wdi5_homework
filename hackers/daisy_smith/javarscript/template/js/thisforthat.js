...
var random = function(array1, array2){
  var result = array1[Math.floor(Math.random() * array1.length)];
  console.log(result);
  var result2 = array2[Math.floor(Math.random() * array2.length)];
  console.log(result2);
}

var answear = random(_this, _that)

console.log(answear);

console.log("So.... your startup is basically like a like a this for that?");
